...
VCFsnps <- read.csv('/data/home/Plutea_mangroves/output_Plutea_host/Variant_Filtration/GVCFall_SNPs.table', header = T, na.strings=c("","NA"), sep = "\t") 
VCFindel <- read.csv('/data/home/Plutea_mangroves/output_Plutea_host/Variant_Filtration/GVCFall_INDELs.table', header = T, na.strings=c("","NA"), sep = "\t")
dim(VCFsnps)
[1] 3004013      11
dim(VCFindel)
[1] 104662     11
...
svg("/data/home/Plutea_mangroves/output_Plutea_host/Variant_Filtration/variant_scores_plots.svg", height=20, width=15)
